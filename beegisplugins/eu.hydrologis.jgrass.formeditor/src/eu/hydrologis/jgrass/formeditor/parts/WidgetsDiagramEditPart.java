...
class WidgetsDiagramEditPart extends AbstractGraphicalEditPart implements PropertyChangeListener {
    ...
    public void propertyChange( PropertyChangeEvent evt ) {
        ...
        if (WidgetsDiagram.CHILD_ADDED_PROP.equals(prop)
                || WidgetsDiagram.CHILD_REMOVED_PROP.equals(prop)) {
            refreshChildren();
        }
    }
    ...
    private static class ShapesXYLayoutEditPolicy extends XYLayoutEditPolicy {
        ...
        protected Command getCreateCommand( CreateRequest request ) {
            ...
            if (childClass == TextFieldWidget.class || childClass == TextAreaWidget.class
                    || childClass == LabelWidget.class || childClass == IntegerFieldWidget.class
