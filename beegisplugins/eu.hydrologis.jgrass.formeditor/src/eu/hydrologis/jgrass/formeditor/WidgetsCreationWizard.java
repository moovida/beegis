...
public class WidgetsCreationWizard extends Wizard implements INewWizard {
    ...
    private class CreationPage extends WizardNewFileCreationPage {
        private static final String DEFAULT_EXTENSION = ".form";
         ...
         * @see WidgetsCreationWizard#init(IWorkbench, IStructuredSelection)
         */
        ...
        private Object createDefaultContent() {
            return new WidgetsDiagram();
        }

        /**
         * This method will be invoked, when the "Finish" button is pressed.
         * @see WidgetsCreationWizard#performFinish()
         */
        boolean finish() {
