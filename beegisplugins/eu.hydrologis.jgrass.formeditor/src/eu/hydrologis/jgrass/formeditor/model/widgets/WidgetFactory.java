...
public class WidgetFactory {
    ...
    public static Widget createWidget( Properties properties ) {
        String type = properties.getProperty(Widget.TYPE_PROP);
        String fieldName = properties.getProperty(Widget.FIELDNAME_PROP);
        String sizeString = properties.getProperty(Widget.SIZE_PROP);
        String[] sizeSplit = sizeString.split(",");
        int width = Integer.parseInt(sizeSplit[0].trim());
        int height = Integer.parseInt(sizeSplit[1].trim());

        String locationString = properties.getProperty(Widget.LOCATION_PROP);
    ...
    private static void addRadioButtonAttributes( RadioButtonWidget widget, Properties properties ) {
        String listString = properties.getProperty(Widget.LIST_PROP);
        widget.setList(listString);
        String selctionString = properties.getProperty(Widget.SELECTION_PROP);
    ...
    private static void addTextFieldAttributes( TextFieldWidget widget, Properties properties ) {
        String defaultString = properties.getProperty(Widget.DEFAULT_PROP);
    ...
    private static void addLabelAttributes( LabelWidget widget, Properties properties ) {
        String textString = properties.getProperty(Widget.TEXT_PROP);
