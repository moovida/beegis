...
/**
 * Action to create a new default type point layer.
 * 
 * @author Andrea Antonello (www.hydrologis.com)
 */
public class NewPointLayer extends Action implements IWorkbenchWindowActionDelegate {
    public static final String ID = "new.layer.points"; //$NON-NLS-1$

    private IWorkbenchWindow window;

    public NewPointLayer() {
        setId(ID);
    }
    ...
    public void run( IAction action ) {
        ...
        fileDialog.setText("Enter a name for the new point layer to be created.");
        fileDialog.setFileName("new_point_layer.shp");
        ...
        try {
            ...
            String message = "An error occurred while creating the default point layer.";
