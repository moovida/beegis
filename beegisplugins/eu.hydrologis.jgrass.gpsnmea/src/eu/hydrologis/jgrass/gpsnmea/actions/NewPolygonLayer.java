...
/**
 * Action to create a new default type polygon layer.
 * 
 * @author Andrea Antonello (www.hydrologis.com)
 *
 */
public class NewPolygonLayer extends Action implements IWorkbenchWindowActionDelegate {
    public static final String ID = "new.layer.polygons"; //$NON-NLS-1$

    private IWorkbenchWindow window;

    public NewPolygonLayer() {
        setId(ID);
    }
    ...
    public void run( IAction action ) {
        ...
        fileDialog.setText("Enter a name for the new polygons layer to be created.");
        fileDialog.setFileName("new_polygon_layer.shp");
        ...
        try {
            ...
            String message = "An error occurred while creating the default polygon layer.";
